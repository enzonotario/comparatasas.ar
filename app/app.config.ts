  ...
  ui: {
    ...
    table: {
      slots: {
        ...
        tr: 'data-[selected=true]:bg-primary-100 dark:data-[selected=true]:bg-primary-900/55 hover:bg-elevated data-[selectable=true]:cursor-pointer transition-colors',
      },
    },
  },
})
