<template>
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 90.7 612 611.1"
    enable-background="new 0 90.7 612 611.1"
    xml:space="preserve"
    class="size-6"
  >
    <path
      id="PMS_130_Coin"
      fill="#F2A900"
      d="M602.7,470c-40.8,163.6-206.6,263.5-370.6,222.7C68.4,651.8-31.4,486.1,9.4,322.5
	S215.9,59,379.5,99.8C543.6,140.1,643.4,306.3,602.7,470z"
    />
    <path
      id="Bitcoin_Symbol"
      fill="#FFFFFF"
      d="M450.9,356.5c5.5-40.8-25.5-62.1-68-76.5l13.2-55.2l-33.6-8.1l-12.8,54
