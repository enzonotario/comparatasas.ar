      ...
      <div class="flex flex-col gap-6 max-w-4xl mx-auto">
        <div class="space-y-4 text-sm leading-relaxed">
          ...
          <p>
            ...
            TEA, usando la tasa del tramo de plazo publicado por el banco (Bancor, BBVA, BNA, Chubut,
            Ciudad, Galicia, Hipotecario, Macro, Patagonia y Santander). Si cargás ingresos
